                                  ...
                                  <div class="central-meta item" v-for="dataa in dataas" v-bind:key="dataa.id">
                                      <div class="user-post">
                                          <div class="friend-info" >
                                              ...
                                              <div class="coment-head" style="position:absolute;left:70%;" v-for="image in dataa[1]" v-bind:key="image.id">
                                                      <button class="we-reply" style="border: none;background-color:#fdfdfd; color:red;" title="refuser" >Demande refuser</button>
                                              </div>
                                              <div class="post-meta" >
