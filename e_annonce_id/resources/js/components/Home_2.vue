                        ...
                        <div class="col-lg-10 col-sm-9">
                            <div class="timeline-info" v-for="user in users" v-bind:key="user.id">
                                <ul>
                                    ...
                                    <li>
                                        <router-link class="active" to="/home2" title="" data-ripple="">Journale</router-link>
                                        <router-link class="" to="/photos" title="" data-ripple="">Photos</router-link>
