                                      ...
                                      <div class="user-post">
                                          <div class="friend-info" >
                                              ...
                                              <div class="coment-head" style="position:absolute;left:80%;" v-for="image in dataa[1]" v-bind:key="image.id">
                                                      <button class="we-reply" style="border: none;background-color:#fdfdfd; color:red;" title="Intéressé" @click="deleteactivepublication(dataa[0].id)"><i class="fa fa-paper-plane"></i> Pas intéressé</button>
                                              </div>
                                              <div class="post-meta" >
